...
int main()
{
    ...
    ourShader.use();
    //ambient color
    ourShader.setVec3("ambient", 0.2f, 0.2f, 0.2f);
    ...
    ourShader.setFloat("cutoff", glm::cos(M_PI/6));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //lighting
        //glm::vec3 lightPos(0.0f * sin(theta), 200.0f, 0.0f * cos(theta));
        theta += 0.05f;
        //urShader.setVec3("lightPos", lightPos);
        
        //spot direction
        ourShader.setVec3("light[0].direction", 50.0f * sin(theta), -200.0f, -50.0f * cos(theta));
        ourShader.setVec3("light[1].direction", -50.0f * sin(theta), -200.0f, -50.0f * cos(theta));
        ourShader.setVec3("light[2].direction", 0.0f * sin(theta), -200.0f, 50.0f * cos(theta));
